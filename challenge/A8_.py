...
def train(epoch):
    ...
    path2 = 'D:/User_Data/Desktop/github/2022-DL/challenge/A8_model/model' + str(epoch) + '.pt'
    torch.save(model.state_dict(), path2)


def HCGNet_A8(num_classes=100):
    return HCGNet(growth_rate=(16, 32, 64), block_config=(1, 1, 1), num_classes=num_classes, bn_size=5, groups=16)


model = HCGNet_A8().to(cuda)
summary_(model, (3, 32, 32), batch_size=1)

path2 = 'D:/User_Data/Desktop/github/2022-DL/challenge/A7_model/model200.pt'
