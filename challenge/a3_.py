...
Original file is located at
    https://colab.research.google.com/drive/1uLkaETmv_TE3u165CxC7CUE_ay7ijv_L
"""
...
train_data_npy_path = "drive/MyDrive/집교2/challenge/data/trainset.npy"
train_label_npy_path = "drive/MyDrive/집교2/challenge/data/trainlabel.npy"
test_data_npy_path = "drive/MyDrive/집교2/challenge/data/testset.npy"
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_dataloader):
        ...
        if (np.float64(np.random.rand(1)) >= 0.7):
        ...
        elif (np.float64(np.random.rand(1)) >= 0.4):
    ...
    print('Epoch:{0}\t lr:{1:.6f}\t duration:{2:.3f}\ttrain_acc:{3:.2f}\ttrain_loss:{4:.6f}'
          .format(epoch, lr, time.time() - start_time, 100. * correct / total, train_loss / (len(train_dataloader)//batch_size)))
    
    path2 = 'drive/MyDrive/집교2/challenge/main/A3/model' + str(epoch) +'.pt'
...
def HCGNet_A3(num_classes=100):
    ...
    # 4 8 12 6 6 6 5 4  try 99k   A5
    # 3 9 19 5 5 5 4 3  try 100k  A4
    # 8 8 8 5 5 5 7 8 try 101k    A3

#NeuralNetwork()
#mobilenetv3()
model = HCGNet_A3().to(cuda)
summary_(model,(3, 32, 32),batch_size=1)



path2 = 'drive/MyDrive/집교2/challenge/main/A3/model1347.pt'
...
for i in range(1348, 2000):
    train(i)

hcg, adam, 0.001 start change to 0.0001
