...
class _SMG(nn.Module):
    def __init__(self, in_channels, growth_rate,
                 bn_size=4, groups=12, reduction_factor=2, forget_factor=2):
...
class HCGNet(nn.Module):
    def __init__(self, growth_rate=(8, 16, 32), block_config=(6,12,24,16),
                 bn_size=2, theta=0.5, num_classes=10):
...
path2 = 'D:/User_Data/Desktop/github/2022-DL/hcgnet/model' + model_num + '.pt'
