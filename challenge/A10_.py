...
def train(epoch):
    ...
    path2 = 'D:/User_Data/Desktop/github/2022-DL/challenge/A10_model/model' + str(epoch) + '.pt'
    torch.save(model.state_dict(), path2)


def HCGNet_A10(num_classes=100):
    return HCGNet(growth_rate=(4, 8, 16), block_config=(6, 6, 6), num_classes=num_classes, bn_size=3, groups=4)


model = HCGNet_A10().to(cuda)
summary_(model, (3, 32, 32), batch_size=1)

#path2 = 'D:/User_Data/Desktop/github/2022-DL/challenge/A10_model/model200.pt'
