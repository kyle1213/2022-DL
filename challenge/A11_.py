...
def train(epoch):
    ...
    path2 = 'D:/User_Data/Desktop/github/2022-DL/challenge/A11_model/model' + str(epoch) + '.pt'
    torch.save(model.state_dict(), path2)


def HCGNet_A11(num_classes=100):
    return HCGNet(growth_rate=(8, 8, 8), block_config=(3, 6, 9), num_classes=num_classes, bn_size=5, groups=8)


model = HCGNet_A11().to(cuda)
