...
class MobileNetV3(nn.Module):
    def __init__(self, n_class=100, input_size=32, dropout=0.5, mode='small', width_mult=1.0):
        ...
        if mode == 'large':
            ...
            last_conv = make_divisible(192 * width_mult)
            self.features.append(conv_1x1_bn(input_channel, last_conv, nlin_layer=Hswish))
...
for t in range(epochs):
    ...
    if t%15 == 1:
      path2 = 'D:/User_Data/Desktop/github/2022-DL/challenge/model' + str(t) +'.pt'
      torch.save(model.state_dict(), path2)
print("Done!")

path2 = 'D:/User_Data/Desktop/github/2022-DL/challenge/model.pt'
torch.save(model.state_dict(), path2)